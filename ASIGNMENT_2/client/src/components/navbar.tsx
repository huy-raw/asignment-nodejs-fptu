                ...
                <div className="flex md:order-2">
                    ...
                    }
                    {
                        ...
                        <div>
                            ...
                            <button type="button" className="mr-4 w-auto px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-600">View details</button>
                        </div>
                    }
                </div>
