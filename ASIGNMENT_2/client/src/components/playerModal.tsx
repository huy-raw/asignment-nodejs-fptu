                                    ...
                                    <div className="">
                                        ...
                                        <div >
                                            ...
                                            <input
                                                ...
                                                id="goals"
                                                min={0}
                                                type="number" className="bg-gray-50 border text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-green-500" />
                                        </div>
                                        <div className="mt-4">
                                            <label htmlFor="position" className="mb-2 text-lg font-medium text-black">Position</label>
                                            <select value={formik.values.position} name="position" id="position" onChange={formik.handleChange} className="ml-2 bg-gray-50 border">
