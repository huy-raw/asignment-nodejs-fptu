                        ...
                        <form className="w-full flex justify-center" onSubmit={formik.handleSubmit}>
                            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    <div>
                                        <div className="mb-3">
                                            <label className="ml-11 font-semibold text-lg">Your name</label>
                                        ...
                                        <div className="mb-3">
                                            <label className="ml-11 font-semibold text-lg">Your Email</label>
                                            <label className="flex justify-center">
                                                <input
                                                    className="w-5/6  rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary"
                                                    placeholder="Email"
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button disabled={isEmpty(formik.values.email) || isEmpty(formik.values.password) || isEmpty(formik.values.name)} name="submit" type="submit" value="Submit" className="mt-3 inline-flex w-full justify-center rounded-md  border-blue-300 bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm disabled:bg-slate-500"  >Save</button>
